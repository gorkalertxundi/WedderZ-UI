...
public class WeatherPanel extends JPanel{
	...
	private void day1Panel(JPanel panel) {
		...
		lblDay1Temperature.setIcon(new ImageIcon("icons\\b_1_partly_cloudy.png"));
	...
	private void day3Panel(JPanel panel) {
		...
		lblDayWeek3 = new JLabel("Miércoles");
	...
	public void updateLocalization(Locality locality, ProcessedData data) {

		lblLocation.setText(locality.getName() + ", ES");
	}
